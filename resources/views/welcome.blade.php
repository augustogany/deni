        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-md-12 mb-3 pb-lg-2">
            ...
            <div class="view zoom z-depth-1">
              ...
              <img src="{{ asset('storage/'.setting('site.banner')) }}" class="img-fluid" alt="sample image">
              ...
              <div class="mask rgba-white-light">
                ...
                <div class="dark-grey-text d-flex align-items-center pt-4 ml-3 pl-3">
                  ...
                  <div>
                    ...
                    <a href="{{route('chat')}} " target="blanck" class="btn btn-danger btn-md btn-rounded clearfix d-none d-md-inline-block"><i class="fab fa-whatsapp fa-lg"></i> Chat</a>
            ...
            <section class="section">
              ...
              <ul class="list-group z-depth-1">
                ...
                @foreach($category as $item)
                    ...
                    @if($cantidad > 0)
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                        <a class="dark-grey-text font-small"><i class="{{ $item->icon}}"aria-hidden="true"></i>{{ $item->name }}</a>
                        <span class="badge badge-danger badge-pill">{{ $cantidad }}</span>
                        </li>
                    @endif
                        @endforeach
                      </ul>
